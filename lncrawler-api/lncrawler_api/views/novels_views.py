...
from ..serializers import (
    BasicNovelSerializer, DetailedNovelSerializer, NovelSourceSerializer,
    ChapterSerializer, ChapterContentSerializer
)
...
def search_novels(request):
    ...
    if sort_by == 'rating':
        ...
        novels_query = novels_query.annotate(
            total_views=Count('view_count__views')
        )
        ...
        novels_query = novels_query.annotate(
            weekly_views=Count('weekly_views__views', 
