...
class Comment(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Ensure that either novel or chapter is set, but not both
        ...
        # Ensure that if this is a reply, it's replying to a comment with the same novel/chapter
        if self.parent:
