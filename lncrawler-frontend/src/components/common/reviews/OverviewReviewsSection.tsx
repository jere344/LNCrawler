...
const OverviewReviewsSection: React.FC<OverviewReviewsSectionProps> = ({
  reviews,
  isLoading,
  maxItems = null
}) => {
  ...
  const slicedReviews = maxItems ? reviews?.slice(0, maxItems) : reviews;
              ...
              <CardContent sx={{ flex: '1 0 auto', p: 3 }}>
                ...
                <Box sx={{
                  ...
                  <ReadOnlyMDXEditor 
                    ...
                    uniqueKey={`overview-review-${review.id}`} 
                  />
                  {!isExpanded && (
                    <Box sx={{ 
                      position: 'absolute', 
